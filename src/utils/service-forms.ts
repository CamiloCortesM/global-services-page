...
>
  <h3 class="mb-5 text-xl font-medium text-gray-900">Additional tasks:</h3>
    ...
    <li>
      ...
      >
        <div class="block">
          ...
          <div class="w-full text-sm">Dusting, vacuuming, sanitizing.</div>
        </div>
      </label>
    </li>
  </ul>
...
<div class="flex-row w-full px-2 md:px-16 mb-6 md:mb-5">
  <label class="block tracking-wide text-gray-700 text-base font-bold mb-2">
    How often would you like the service? <span class="text-red-500">*</span
    >
  </label>
...
<div class="flex-row w-full px-2 md:px-16 mb-6 md:mb-5">
  <label class="block tracking-wide text-gray-700 text-base font-bold mb-2">
    Would you prefer the company to provide the necessary cleaning supplies
    or would you prefer to provide them yourself? <span class="text-red-500"
      >*</span
    >
  </label>
